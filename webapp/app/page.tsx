      ...
      <main className="flex min-h-screen w-full max-w-3xl flex-col items-center justify-center gap-8 py-32 px-16 bg-white dark:bg-black">
        <div className="flex flex-col items-center gap-6 text-center">
          <h1 className="text-5xl font-bold tracking-tight text-black dark:text-zinc-50">
            FactCheck FactSource
          </h1>
          <p className="max-w-2xl text-xl leading-8 text-zinc-600 dark:text-zinc-400">
            Verify facts and check sources with confidence.
          </p>
          <p className="max-w-2xl text-base leading-7 text-zinc-500 dark:text-zinc-500">
            This web application provides tools for fact-checking and source verification. 
            Get started by exploring the features or checking out the documentation.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-4 text-base font-medium sm:flex-row">
          ...
          <a
            ...
            href="https://github.com/WylieDituri/FactCheckFactSource"
            target="_blank"
